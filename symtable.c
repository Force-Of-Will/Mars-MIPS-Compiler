...
struct SymbTab * first = NULL;//global to this structure POINTER TO THE FIRST THING IN THIS LINKED LIST (starts as NULL)
...
//precondition: someone calls this to make a temp tLABEL
//postcondition: returned string s that holds the temp label
char * CreateTemp() { 
    char hold[100];
    char *s;
